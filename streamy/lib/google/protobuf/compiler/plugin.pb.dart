...
///
library google.protobuf.compiler;
...
class CodeGeneratorRequest extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CodeGeneratorRequest')
    ...
    ..m(15, 'protoFile', () => new google$protobuf.FileDescriptorProto(), () => new PbList<google$protobuf.FileDescriptorProto>())
  ;
  ...
  List<google$protobuf.FileDescriptorProto> get protoFile => getField(15);
}
