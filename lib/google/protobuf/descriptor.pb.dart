...
class SourceCodeInfo_Location extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('SourceCodeInfo_Location')
    ...
    ..a(3, 'leadingComments', GeneratedMessage.OS)
    ..a(4, 'trailingComments', GeneratedMessage.OS)
    ..hasRequiredFields = false
  ;
  ...
  String get leadingComments => getField(3);
  void set leadingComments(String v) { setField(3, v); }
  bool hasLeadingComments() => hasField(3);
  void clearLeadingComments() => clearField(3);

  String get trailingComments => getField(4);
  void set trailingComments(String v) { setField(4, v); }
  bool hasTrailingComments() => hasField(4);
