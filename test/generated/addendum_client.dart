...
class AddendumTest extends streamy.HttpRoot with AddendumTestResourceMixin {
  ...
  static final String API_TYPE = r'AddendumTest';

  String get apiType => r'AddendumTest';

  AddendumTest(streamy.RequestHandler this.requestHandler, {streamy.TransactionStrategy this.txStrategy, streamy.Tracer this.tracer: const streamy.NoopTracer(), String servicePath: r'addendum/v1/'}) : super(r'addendum/v1/');
